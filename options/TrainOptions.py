...
class TrainLenEstOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--max_epoch',type=int,default=500,help='训练次数')
        self.parser.add_argument('--checkpoints_dir', type=str, default='../xinglin-data/text2len/checkpoints', help='models are saved here')
        ...
        self.parser.add_argument('--batch_size', type=int, default=32, help='每一次训练的样本数')
